...
class Terrain:
    def __init__(self):
        self.rows = 700
        self.columns = 700 # Matrices bigger than 700x700 refuses to render, instead increase the meshScale at self.terrain_shape.
